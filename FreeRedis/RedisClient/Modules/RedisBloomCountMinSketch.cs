...
namespace FreeRedis
{
    partial class RedisClient
    {
        ...
        public long[] CmsIncrBy(string key, Dictionary<string, long> itemIncrements) => Call("CMS.INCRBY".Input(key).InputKv(itemIncrements).FlagKey(key), rt => rt.ThrowOrValue<long[]>());
